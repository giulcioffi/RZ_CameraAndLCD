...
public:
    ...
    virtual bool Initialise() {
        ...
        const char RaspberryPi_InitRegTable_2[][3] = {
            ...
            {0x01, 0x60, 0x0A}, {0x01, 0x61, 0xA8}, {0x01, 0x64, 0x01}, {0x01, 0x65, 0x80},
            {0x01, 0x66, 0x0C}, {0x01, 0x67, 0xCF}, {0x01, 0x68, 0x00}, {0x01, 0x69, 0x08},
            {0x01, 0x6A, 0x09}, {0x01, 0x6B, 0xFF}, {0x01, 0x6C, 0x02}, {0x01, 0x6D, 0x80},
            {0x01, 0x6E, 0x02}, {0x01, 0x6F, 0x80}, {0x01, 0x8C, 0x08}, {0x01, 0x8D, 0x08},
            {0x01, 0x74, 0x02}, {0x01, 0x75, 0x02}, {0x01, 0x76, 0x01}, {0x01, 0x77, 0x01},
            {0x01, 0x57, 0xC0}, {0x01, 0x5A, 0x04}, {0x01, 0x5B, 0x00}, {0x01, 0x1C, 0x00},
            {0x01, 0x1D, 0x57}, {0x01, 0x24, 0x00}, {0x01, 0x25, 0xBF}, {0x03, 0x01, 0x05},
            {0x03, 0x04, 0x02}, {0x03, 0x05, 0x02}, {0x03, 0x06, 0x00}, {0x03, 0x07, 0x3A},
    ...
    #define     CAM_VIN_PRECLIP_WIDTH_Y  (616u)                 /* Line width of pre clip area */
